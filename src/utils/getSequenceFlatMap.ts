...
export function getSequenceFlatMap<T extends Sequence | ComponentBlock>(sequence: T | string[]): string[] {
  return Array.isArray(sequence) ? sequence : sequence.components.flatMap((component) => (typeof component === 'string' ? component : getSequenceFlatMap(component)));
}
